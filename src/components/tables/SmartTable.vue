      ...
      >
        <q-card flat>
          <q-card-section class="text-caption">
            ...
            <div><strong>Total Records:</strong> {{ totalCount.toLocaleString() }}</div>
            <div><strong>Visible Records:</strong> {{ visibleData.length.toLocaleString() }}</div>
...
import { useSmartTable, type SmartTableConfig } from 'src/composables/useSmartTable';
...
const strategyColor = computed(() => {
  switch (strategy.value) {
    case 'client-side': return 'green';
    case 'server-side': return 'blue';
    case 'virtualized': return 'purple';
    default: return 'grey';
  }
});
...
const strategyIcon = computed(() => {
  switch (strategy.value) {
    case 'client-side': return 'memory';
    case 'server-side': return 'cloud';
    case 'virtualized': return 'view_list';
