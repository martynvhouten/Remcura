export default {
  ...
  auth: {
    ...
    platformDescription: 'Optimice la gestión de su inventario médico con nuestra plataforma de nivel empresarial. Rastree existencias, gestione pedidos y asegure el cumplimiento con facilidad.',
    ...
    demoCredentialsFilled: 'Credenciales de demostración completadas. Haga clic en Iniciar sesión para continuar.',
    ...
    demoHelp: 'Use demo@medstock-pro.com con contraseña demo123 para demostración',
  ...
  settings: {
    ...
    contactSettingsNotice: 'Para modificar la información de la clínica, póngase en contacto con el administrador.',
    ...
    emailNotificationsDescription: 'Recibir actualizaciones importantes por correo electrónico',
    ...
    manageSettingsSubtitle: 'Gestione su configuración y preferencias para una experiencia óptima',
    
    // Style Guide translations
    styleGuideTitle: 'Guía de Estilo MedStock Pro',
    styleGuideSubtitle: 'Referencia completa del sistema de diseño y muestra de componentes',
  ...
  error: {
    ...
    pageNotFoundDescription: 'Lo sentimos, la página que busca no se puede encontrar. Puede haber sido movida, eliminada, o ingresó una URL incorrecta.',
    goHome: 'Ir al inicio',
    goBack: 'Regresar',
    tryThesePages: 'Intente visitar una de estas páginas populares en su lugar:'
  },
  ...
  counting: {
    ...
    overview: 'Gestione sus sesiones de conteo de existencias y seguimiento de precisión de inventario',
    ...
    sessionNotFoundDescription: 'La sesión de conteo que busca no se pudo encontrar',
  ...
  locations: {
    ...
    comingSoonDescription: 'Las funciones de gestión de ubicaciones estarán disponibles pronto. Podrá crear y gestionar diferentes áreas de almacenamiento para su inventario.'
  },
  ...
  messages: {
    ...
    addAllSuggestionsComingSoon: 'Función de agregar todas las sugerencias próximamente',
  ...
  notifications: {
    ...
    permissions: {
      ...
      description: 'Reciba notificaciones sobre actualizaciones importantes y existencias bajas'
    }
  },
  ...
  offline: {
    ...
    messages: {
      workingOffline: 'Trabajando sin conexión - los cambios se sincronizarán cuando esté en línea',
  ...
  suppliersPage: {
    title: 'Proveedores',
    subtitle: 'Gestione sus relaciones con proveedores e información de vendedores',
    ...
    linkToMagentoPrompt: 'Ingrese el ID de vendedor Magento para vincular este proveedor:',
  ...
  notificationsPage: {
    ...
    clearAllConfirmMessage: '¿Está seguro de que desea eliminar todas las notificaciones? Esta acción no se puede deshacer.',
