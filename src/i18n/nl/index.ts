export default {
  ...
  nav: {
    ...
    admin: "Beheer",
    products: "Producten",
    overviewAnalytics: "Overzicht & analytics",
  ...
  dashboard: {
    ...
    welcomeSubtitle: "Je medische voorraadbeheer systeem",
    welcomeDescription: "Welkom bij je medische voorraadbeheer dashboard. Dit systeem helpt je om je medische voorraden efficiënt te volgen en beheren.",
    systemStatus: "Systeem Status",
    systemStatusSubtitle: "Huidige systeem informatie",
    systemOnline: "Systeem Online",
    dataSynced: "Gegevens Gesynchroniseerd",
    secureConnection: "Beveiligde Verbinding",
  },
  ...
  inventory: {
    ...
    batch: {
      ...
      requestedQuantity: "Gewenste hoeveelheid",
      generateFifoSuggestion: "FIFO Suggestie Genereren",
      fifoResults: "FIFO Resultaten",
      noFifoResults: "Geen FIFO resultaten",
      useQuantity: "Te gebruiken hoeveelheid",
      ...
      expiryInformation: "Verval Informatie",
  ...
  analytics: {
    ...
    comingSoon: "Binnenkort beschikbaar",
    comingSoonDescription: "Geavanceerde analytics en rapportage functies worden binnenkort toegevoegd.",
    overview: "Overzicht",
    trends: "Trends",
    reports: "Rapporten",
    insights: "Inzichten",
