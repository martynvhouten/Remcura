  ...
  <div class="dialog-examples">
    ...
    >
      <div class="confirm-content">
        <p>Are you sure you want to delete <strong>{{ productToDelete }}</strong>?</p>
        <p class="text-danger">This will permanently remove the product and all associated data.</p>
      </div>
    </BaseDialog>
