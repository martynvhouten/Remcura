        ...
        <q-card class="glass-card">
          <q-card-section>
            <div class="row items-center justify-between">
              <div class="col-auto">
                <div class="text-h6">{{ $t('notificationsPage.notificationStatistics') }}</div>
              </div>
              <div class="col-auto">
                <q-btn-group flat>
                  <q-btn 
            ...
            <div class="row q-gutter-md q-mt-sm">
              <div class="col">
                <div class="text-center">
                  ...
                  <div class="text-caption">{{ $t('notificationsPage.unreadCount') }}</div>
                </div>
              </div>
              <div class="col">
                <div class="text-center">
                  <div class="text-h4">{{ mockNotifications.length }}</div>
                  <div class="text-caption">{{ $t('notificationsPage.total') }}</div>
                </div>
              </div>
            </div>
          </q-card-section>
        ...
        >
          <template #header-actions>
            ...
            <div v-if="filteredNotifications.length === 0" class="text-center q-py-xl">
              ...
              <div class="text-h6 text-grey-6 q-mt-md">{{ $t('notificationsPage.noNotifications') }}</div>
              <div class="text-body2 text-grey-5">{{ $t('notificationsPage.allCaughtUp') }}</div>
            </div>
            ...
            <q-list v-else separator>
              ...
              >
                <q-item-section avatar>
                  <q-avatar :color="getCategoryColor(notification.category)" text-color="white">
...
const categoryOptions = computed(() => [
  ...
  { label: t('notificationsPage.categories.orderUpdate'), value: 'order_update' },
  { label: t('notificationsPage.categories.systemNotification'), value: 'system_notification' },
...
const deleteNotification = async (notificationId: string) => {
  try {
    mockNotifications.value = mockNotifications.value.filter(n => n.id !== notificationId)
...
const createTestNotification = async (type: 'stock_alert' | 'order_update') => {
  try {
    ...
    const successMessage = type === 'stock_alert' 
