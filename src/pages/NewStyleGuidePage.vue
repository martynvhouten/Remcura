  ...
  <PageLayout>
    ...
    <div class="style-guide-page">
      ...
      <div class="migration-notice">
        ...
        >
          <p>
            We've simplified our card system from 12+ variants to 3 clear categories. 
            This improves consistency, maintainability, and user experience.
          </p>
      ...
      <div v-if="showOldGuide" class="old-system-section">
        ...
        <p class="deprecated-notice">
          The following variants have been deprecated in favor of our new 3-category system:
        </p>
        ...
        <div class="deprecated-cards-grid">
          <div class="deprecated-card">
            <BaseCard
              ...
              icon-color="primary"
            >
              <p>This variant had overly complex hover effects with heavy transforms and animations.</p>
              <div class="replacement-note">
                <strong>Replace with:</strong> BaseCard or InteractiveCard (depending on clickability)
              </div>
            </BaseCard>
          </div>
          ...
          <div class="deprecated-card">
            ...
            >
              <p>Neumorphism effects don't work well across all browsers and themes.</p>
              <div class="replacement-note">
          ...
          <div class="deprecated-card">
            <BaseCard
              ...
              icon-color="warning"
            >
              <p>Animated gradient borders were too distracting from content.</p>
              <div class="replacement-note">
