...
describe("useFormValidation", () => {
  ...
  describe("validation rules", () => {
    ...
    it("should validate email format", () => {
      ...
      expect(rules.email("invalid-email")).toBe(
        "Voer een geldig e-mailadres in"
      );
      expect(rules.email("test@")).toBe("Voer een geldig e-mailadres in");
      expect(rules.email("@example.com")).toBe(
        "Voer een geldig e-mailadres in"
      );
    ...
    it("should validate maximum length", () => {
      ...
      expect(maxLength10("hello world")).toBe(
        "Maximaal 10 karakters toegestaan"
      );
  ...
  describe("validateForm", () => {
    it("should validate all fields and return overall validity", () => {
      ...
      const field3 = createField("test@example.com", [
        rules.required,
        rules.email,
      ]);
